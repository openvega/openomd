...
{
    // Warrant
    char msg[] = "\x64\x04\x03\x00\x86\xf8\x38\x00\x00\x92\x93\xb3\xb8\x3b\x3f\x16" \
        "\x28\x02\x0b\x00\xa4\x60\x00\x00\x4d\x41\x49\x4e\x4e\x4c\x30\x30" \
        "\x31\x35\x31\x31\x38\x32\x38\x32\x57\x52\x4e\x54\x03\x00\x30\x31" \
        "\x4a\x50\x4a\x44\x43\x4f\x4d\x40\x45\x43\x32\x31\x30\x31\x42\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x48\x4b\x44\xac\x4e\x71\x67\x69" \
        "\x64\x1a\x90\x00\x4e\x00\x4e\xfc\x8c\x22\xff\x00\x30\x00\x30\x00" \
        "\x30\x00\x30\x00\x30\x00\x30\x00\x30\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\xac\x4e\x1c\x4e\x69\x64\x1a\x90\x00" \
        "\x4e\x00\x4e\x2d\x8d\x22\xff\x00\x30\x00\x30\x00\x30\x00\x30\x00" \
        "\x30\x00\x30\x00\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x88\x13\x00\x00\x00\x00\x00\x00\xbe\x00\x00\x00\x4e" \
        "\x4e\x4e\x59\x4e\x00\x4e\x00\x78\x3d\x34\x01\x00\x00\x00\x00\x45" \
        "\x58\x45\x52\x20\x44\x41\x54\x45\x3a\x31\x32\x2f\x30\x31\x2f\x32" \
        "\x31\x20\x2a\x4c\x50\x39\x37\x31\x31\x2d\x32\x38\x30\x30\x20\x37" \
        "\x38\x37\x38\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x4e\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x20\x20\x20\x00\x00\x00\x00\x20" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xa0\x86\x01\x00" \
        "\x9c\x31\x05\x00\x00\x00\x00\x00\xc0\x61\x34\x01\x43\x45\x00\x00" \
        "\x4e\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x64\x00\x00\x00\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00" \
        "\x92\x25\x00\x00\x00\x00\x00\x00";
    ...
    struct Processor : public OMDCP
    {
        ...
        {
            EXPECT_EQ(24740, sd.securityCode());
            EXPECT_EQ("MAIN", sd.getMarketCodeAsString());
            EXPECT_EQ("NL0015118282", sd.getIsinCodeAsString());
            EXPECT_EQ("WRNT", sd.getInstrumentTypeAsString());
            EXPECT_EQ(3, sd.productType());
            EXPECT_EQ("01", sd.getSpreadTableCodeAsString());
            EXPECT_EQ("JPJDCOM@EC2101B                         ", sd.getSecurityShortNameAsString());
            EXPECT_EQ("HKD", sd.getCurrencyCodeAsString());
            EXPECT_EQ(5000, sd.lotSize());
            EXPECT_EQ(190, sd.previousClosingPrice());
            ...
            EXPECT_EQ(20200824, sd.listingDate());
            EXPECT_EQ(0, sd.delistingDate());
            EXPECT_EQ("EXER DATE:12/01/21 *LP9711-2800 7878  ", sd.getFreeTextAsString());
            EXPECT_EQ(78, sd.posFlag());
            EXPECT_EQ(0, sd.posUpperLimit());
            EXPECT_EQ(0, sd.posLowerLimit());
            EXPECT_EQ(0, sd.efnFlag());
            EXPECT_EQ(0, sd.accruedInterest());
            EXPECT_EQ(0, sd.couponRate());
            EXPECT_EQ(100000, sd.conversionRatio());
            EXPECT_EQ(340380, sd.strikePrice1());
            EXPECT_EQ(0, sd.strikePrice2());
            EXPECT_EQ(20210112, sd.maturityDate());
            ...
            EXPECT_EQ(1, sd.entitlement());
            EXPECT_EQ(0, sd.decimalsInEntitlement());
            EXPECT_EQ(100, sd.noWarrantsPerEntitlement());
            auto& underlyings = sd.noUnderlyingSecurities();
            EXPECT_EQ(1, underlyings.count());
            EXPECT_EQ(true, underlyings.hasNext());
            underlyings.next();
            EXPECT_EQ(9618, underlyings.underlyingSecurityCode());
            _tc = true;
        }
        using OMDCProcessor::onMessage;
    };
    ...
    // CBBC
    char cbbcMsg[] = "\x5c\x04\x03\x00\x7b\xfd\x38\x00\x00\x19\x42\x6e\xb9\x3b\x3f\x16" \
        "\x20\x02\x0b\x00\x5e\xc3\x00\x00\x4d\x41\x49\x4e\x48\x4b\x30\x30" \
        "\x30\x30\x36\x34\x38\x31\x31\x30\x57\x52\x4e\x54\x0b\x00\x30\x31" \
        "\x48\x54\x23\x48\x53\x49\x20\x20\x52\x50\x32\x31\x30\x31\x5a\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x48\x4b\x44\x52\x60\x07\x63\x77" \
        "\x6d\x1a\x90\x00\x4e\x00\x4e\x8a\x71\x3a\xff\x00\x30\x00\x30\x00" \
        "\x30\x00\x30\x00\x30\x00\x30\x00\x30\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x52\x60\x07\x63\x77\x6d\x1a\x90\x00" \
        "\x4e\x00\x4e\x8a\x71\x3a\xff\x00\x30\x00\x30\x00\x30\x00\x30\x00" \
        "\x30\x00\x30\x00\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x10\x27\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x4e" \
        "\x4e\x4e\x59\x4e\x00\x4e\x00\xc5\x3d\x34\x01\x00\x00\x00\x00\x43" \
        "\x50\x3d\x32\x35\x37\x32\x38\x2a\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x4c\x50\x39\x36\x39\x39\x2a\x32\x32\x31\x33\x38\x30\x38" \
        "\x38\x2a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x20\x20\x20\x4e\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        ...
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x1b\xb7\x00" \
        "\xa0\x1a\x8a\x01\x00\x00\x00\x00\xd0\x61\x34\x01\x50\x45\x00\x00" \
        "\x4e\x80\x64\x00\x00\x00\x01\x00\x00\x00\x00\xe0\x2e\x00\x00\x48" \
        "\x53\x49\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" \
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00";
    ...
    struct CbbcProcessor : public OMDCP
    {
        ...
        void onMessage(sbe::SecurityDefinition& sd, uint32_t)
        {
            EXPECT_EQ(50014, sd.securityCode());
            EXPECT_EQ("MAIN", sd.getMarketCodeAsString());
            EXPECT_EQ("HK0000648110", sd.getIsinCodeAsString());
            EXPECT_EQ("WRNT", sd.getInstrumentTypeAsString());
            EXPECT_EQ(11, sd.productType());
            EXPECT_EQ("01", sd.getSpreadTableCodeAsString());
            EXPECT_EQ("HT#HSI  RP2101Z                         ", sd.getSecurityShortNameAsString());
            EXPECT_EQ("HKD", sd.getCurrencyCodeAsString());
            EXPECT_EQ(10000, sd.lotSize());
            EXPECT_EQ(128, sd.previousClosingPrice());
            EXPECT_EQ(78, sd.vcmFlag());
            EXPECT_EQ(78, sd.shortSellFlag());
            EXPECT_EQ(78, sd.casFlag());
            EXPECT_EQ(89, sd.ccassFlag());
            EXPECT_EQ(78, sd.dummySecurityFlag());
            EXPECT_EQ(78, sd.stampDutyFlag());
            EXPECT_EQ(20200901, sd.listingDate());
            EXPECT_EQ(0, sd.delistingDate());
            EXPECT_EQ("CP=25728*          LP9699*22138088*   ", sd.getFreeTextAsString());
            EXPECT_EQ(78, sd.posFlag());
            EXPECT_EQ(0, sd.posUpperLimit());
            EXPECT_EQ(0, sd.posLowerLimit());
            EXPECT_EQ(0, sd.efnFlag());
            EXPECT_EQ(0, sd.accruedInterest());
            EXPECT_EQ(0, sd.couponRate());
            EXPECT_EQ(12000000, sd.conversionRatio());
            EXPECT_EQ(25828000, sd.strikePrice1());
            EXPECT_EQ(0, sd.strikePrice2());
            EXPECT_EQ(20210128, sd.maturityDate());
            EXPECT_EQ(80, sd.callPutFlag());
            EXPECT_EQ(69, sd.style());
            EXPECT_EQ(78, sd.warrantType());
            EXPECT_EQ(25728, sd.callPrice());
            EXPECT_EQ(0, sd.decimalsInCallPrice());
            EXPECT_EQ(1, sd.entitlement());
            EXPECT_EQ(0, sd.decimalsInEntitlement());
            EXPECT_EQ(12000, sd.noWarrantsPerEntitlement());
            auto& underlyings = sd.noUnderlyingSecurities();
