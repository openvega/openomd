...
#ifndef _OMDD_SBE_GROUPSIZE_H_
#define _OMDD_SBE_GROUPSIZE_H_
...
public:
    GroupSize() : m_buffer(nullptr), m_offset(0) {}
    ...
    GroupSize& operator=(GroupSize&& codec) SBE_NOEXCEPT
    {
        m_buffer = codec.m_buffer;
        m_bufferLength = codec.m_bufferLength;
        m_offset = codec.m_offset;
    ...
    GroupSize& operator=(const GroupSize& codec) SBE_NOEXCEPT
    {
        m_buffer = codec.m_buffer;
        m_bufferLength = codec.m_bufferLength;
        m_offset = codec.m_offset;
