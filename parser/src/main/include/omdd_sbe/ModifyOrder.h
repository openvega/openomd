...
#ifndef _OMDD_SBE_MODIFYORDER_H_
#define _OMDD_SBE_MODIFYORDER_H_
...
#pragma clang diagnostic pop
    ...
    ModifyOrder &price(const std::int32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    ModifyOrder &side(const std::uint8_t value)
    {
...
#pragma clang diagnostic pop
    ...
    ModifyOrder &orderType(const std::uint16_t value)
    {
...
#pragma clang diagnostic pop
    ...
    ModifyOrder &orderBookPosition(const std::uint32_t value)
    {
