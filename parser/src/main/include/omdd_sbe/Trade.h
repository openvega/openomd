...
#pragma clang diagnostic pop
    ...
    {
        return SBE_LITTLE_ENDIAN_ENCODE_16(*((std::int16_t *)(m_buffer + m_offset + 34)));
    }

    Trade &filler2(const std::int16_t value)
    {
        *((std::int16_t *)(m_buffer + m_offset + 34)) = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        return *this;
    }
