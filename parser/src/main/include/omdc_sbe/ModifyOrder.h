...
#pragma clang diagnostic pop
    ...
    static SBE_CONSTEXPR std::int32_t filler2NullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT32;
    }

    static SBE_CONSTEXPR std::int32_t filler2MinValue() SBE_NOEXCEPT
    {
        return -2147483647;
    }

    static SBE_CONSTEXPR std::int32_t filler2MaxValue() SBE_NOEXCEPT
    {
        return 2147483647;
    }
    ...
    std::int32_t filler2() const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::int32_t *)(m_buffer + m_offset + 18)));
    }

    ModifyOrder &filler2(const std::int32_t value)
    {
        *((std::int32_t *)(m_buffer + m_offset + 18)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::int32_t *)(m_buffer + m_offset + 22)));
    }

    ModifyOrder &orderBookPosition(const std::int32_t value)
    {
        *((std::int32_t *)(m_buffer + m_offset + 22)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }
};
}
