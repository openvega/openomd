...
#ifndef _OMDC_SBE_INDICATIVEEQUILIBRIUMPRICE_H_
#define _OMDC_SBE_INDICATIVEEQUILIBRIUMPRICE_H_
...
private:
    ...
    inline void reset(const IndicativeEquilibriumPrice& codec)
    {
...
public:
    ...
    IndicativeEquilibriumPrice() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    IndicativeEquilibriumPrice(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    IndicativeEquilibriumPrice(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    IndicativeEquilibriumPrice(const IndicativeEquilibriumPrice& codec)
    {
        reset(codec);
    }

#if __cplusplus >= 201103L
    IndicativeEquilibriumPrice(IndicativeEquilibriumPrice&& codec)
    {
        reset(codec);
    }

    IndicativeEquilibriumPrice& operator=(IndicativeEquilibriumPrice&& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    IndicativeEquilibriumPrice& operator=(const IndicativeEquilibriumPrice& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    IndicativeEquilibriumPrice &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    IndicativeEquilibriumPrice &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    IndicativeEquilibriumPrice &securityCode(const std::uint32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    IndicativeEquilibriumPrice &price(const std::int32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    IndicativeEquilibriumPrice &aggregateQuantity(const std::uint64_t value)
    {
