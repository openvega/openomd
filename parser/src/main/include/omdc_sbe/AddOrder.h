...
#ifndef _OMDC_SBE_ADDORDER_H_
#define _OMDC_SBE_ADDORDER_H_
...
#pragma clang diagnostic pop
    ...
    AddOrder &securityCode(const std::uint32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    AddOrder &side(const std::uint16_t value)
    {
...
#pragma clang diagnostic pop
    ...
    static SBE_CONSTEXPR char orderTypeNullValue() SBE_NOEXCEPT
    {
        return (char)0;
    }

    static SBE_CONSTEXPR char orderTypeMinValue() SBE_NOEXCEPT
    {
        return (char)32;
    }

    static SBE_CONSTEXPR char orderTypeMaxValue() SBE_NOEXCEPT
    {
        return (char)126;
    }
    ...
    {
        return (*((char *)(m_buffer + m_offset + 22)));
    }

    AddOrder &orderType(const char value)
    {
        *((char *)(m_buffer + m_offset + 22)) = (value);
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    char filler() const
    {
        return (*((char *)(m_buffer + m_offset + 23)));
    }

    AddOrder &filler(const char value)
    {
        *((char *)(m_buffer + m_offset + 23)) = (value);
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    AddOrder &orderBookPosition(const std::int32_t value)
    {
