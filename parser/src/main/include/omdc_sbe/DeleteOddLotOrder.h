...
#ifndef _OMDC_SBE_DELETEODDLOTORDER_H_
#define _OMDC_SBE_DELETEODDLOTORDER_H_
...
private:
    ...
    inline void reset(const DeleteOddLotOrder& codec)
    {
...
public:
    ...
    DeleteOddLotOrder() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    DeleteOddLotOrder(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    DeleteOddLotOrder(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    DeleteOddLotOrder(const DeleteOddLotOrder& codec)
    {
        reset(codec);
    }

#if __cplusplus >= 201103L
    DeleteOddLotOrder(DeleteOddLotOrder&& codec)
    {
        reset(codec);
    }

    DeleteOddLotOrder& operator=(DeleteOddLotOrder&& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    DeleteOddLotOrder& operator=(const DeleteOddLotOrder& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    DeleteOddLotOrder &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    DeleteOddLotOrder &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    DeleteOddLotOrder &securityCode(const std::uint32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    DeleteOddLotOrder &brokerID(const std::uint16_t value)
    {
...
#pragma clang diagnostic pop
    ...
    DeleteOddLotOrder &side(const std::uint16_t value)
    {
