...
#ifndef _OMDD_SBE_RETRANSMISSIONREQUEST_H_
#define _OMDD_SBE_RETRANSMISSIONREQUEST_H_
...
private:
    ...
    inline void reset(const RetransmissionRequest& codec)
    {
...
public:
    ...
    RetransmissionRequest() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    RetransmissionRequest(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    RetransmissionRequest(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    RetransmissionRequest(const RetransmissionRequest& codec)
    {
        reset(codec);
    }

#if __cplusplus >= 201103L
    RetransmissionRequest(RetransmissionRequest&& codec)
    {
        reset(codec);
    }

    RetransmissionRequest& operator=(RetransmissionRequest&& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    RetransmissionRequest& operator=(const RetransmissionRequest& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    RetransmissionRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    RetransmissionRequest &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    RetransmissionRequest &channelID(const std::uint16_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionRequest &filler1(const std::uint16_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionRequest &beginSeqNum(const std::uint32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionRequest &endSeqNum(const std::uint32_t value)
    {
