...
#ifndef _OMDD_SBE_ORDERBOOKCLEAR_H_
#define _OMDD_SBE_ORDERBOOKCLEAR_H_
...
private:
    ...
    inline void reset(const OrderbookClear& codec)
    {
...
public:
    ...
    OrderbookClear() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    OrderbookClear(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    OrderbookClear(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    OrderbookClear(const OrderbookClear& codec)
    {
        reset(codec);
    }

#if __cplusplus >= 201103L
    OrderbookClear(OrderbookClear&& codec)
    {
        reset(codec);
    }

    OrderbookClear& operator=(OrderbookClear&& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    OrderbookClear& operator=(const OrderbookClear& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    OrderbookClear &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    OrderbookClear &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    OrderbookClear &orderbookID(const std::uint32_t value)
    {
