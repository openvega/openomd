...
#ifndef _OMDD_SBE_RETRANSMISSIONRESPONSE_H_
#define _OMDD_SBE_RETRANSMISSIONRESPONSE_H_
...
private:
    ...
    inline void reset(const RetransmissionResponse& codec)
    {
...
public:
    ...
    RetransmissionResponse() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    RetransmissionResponse(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    RetransmissionResponse(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    RetransmissionResponse(const RetransmissionResponse& codec)
    {
        reset(codec);
    }

#if __cplusplus >= 201103L
    RetransmissionResponse(RetransmissionResponse&& codec)
    {
        reset(codec);
    }

    RetransmissionResponse& operator=(RetransmissionResponse&& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    RetransmissionResponse& operator=(const RetransmissionResponse& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    RetransmissionResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    RetransmissionResponse &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    RetransmissionResponse &channelID(const std::uint16_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionResponse &retransStatus(const std::uint8_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionResponse &filler1(const std::uint8_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionResponse &beginSeqNum(const std::uint32_t value)
    {
...
#pragma clang diagnostic pop
    ...
    RetransmissionResponse &endSeqNum(const std::uint32_t value)
    {
