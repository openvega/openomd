...
namespace openomd
{
// For safe to make a copy to provide 2 parser implementation. will fully migrate to Compression parser after OMDD DS upgrade
class OmddParser : public OmdBaseParser<NoopCompressionPolicy>
{
